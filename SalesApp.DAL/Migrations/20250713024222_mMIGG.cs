...
{
    /// <inheritdoc />
    public partial class mMIGG : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SUserId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatHubs_Users_FUserId",
                        column: x => x.FUserId,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ChatHubs_Users_SUserId",
                        column: x => x.SUserId,
                        principalTable: "Users",
                        principalColumn: "UserID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatHubs_FUserId",
                table: "ChatHubs",
                column: "FUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatHubs_SUserId",
                table: "ChatHubs",
                column: "SUserId");
